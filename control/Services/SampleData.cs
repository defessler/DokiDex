...
// vocabulary with NO backend — healthy + degraded(pulse) + crashed* + not-installed(ghost), model-swap
// chips, both DokiCode/DokiGen bands, a live-looking GPU meter. (*crashed is forced in
...
internal static class SampleData
{
    public static StatusDoc Status() => new()
    {
        ...
        Services = new()
        {
            ...
            new() { Name = "tts",        Group = "llm", Installed = true, Running = true, Healthy = true,  Port = 8004, Ui = "http://127.0.0.1:8004/", VramGb = 4, Pid = 13010 },
